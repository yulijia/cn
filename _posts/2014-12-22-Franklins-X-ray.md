...
$$Rsin\frac{2\phix}{P}+\frac{\alpha}{2}$$ 和 $$Rsin\frac{2\phix}{P}-\frac{\alpha}{2}$$，其中$$x_1<x<x_2$$。衍射图形$$F^2(k_x,k_y)$$ 可以从下图中得到。
