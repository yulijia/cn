...
![projection_pattern_of_spring](https://i.imgur.com/hVNBbmw.png)
...
![far-field_diffraction_pattern_design](https://i.imgur.com/Gm26M5E.png)


通过衍射实验，我们可以得到弹簧线圈的多个间距，为了得到半径，需要首先知道间距的数值P。间距是螺旋之间的距离，也就是sin函数的波长。
![sine-function](https://i.imgur.com/vWrkyfr.png)
...
![far-field_diffraction_pattern](https://i.imgur.com/8f1t65T.png)
...
![eq5](https://i.imgur.com/FR4LQbs.png)
