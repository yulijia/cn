...
然后今天实在是慢的不可忍了，搜索了CDN加速服务，貌似大家现在使用最多的是[七牛云加速](https://portal.qiniu.com/signup?code=3llo7m7u16dea "注册邀请链接")，但是这个很麻烦，对体验用户（非实名）限制也多。 通过搜索，我找到了[百度云加速](http://next.su.baidu.com/ "百度云加速")。
...
只要有百度的帐号（应该都有吧，之前的大容量云盘战争来历历在目<code>'_>`</code>），就可以立即使用。
